...
class CADPCMFileStream : public Spt::Class
{
    ...
    class IDirectSoundStream* m_pRenderFilter;							// Render (DirectSoundStream) filter
    ...
    class XFileMediaObject*   m_pSourceFilter;							// Source (wave file) filter
	...
	bool				IsCompleted( void )						{ return ( m_Completed && ( /*XMEDIAPACKET_STATUS_PENDING*/1 != m_adwPacketStatus[m_LastPacket])); }
