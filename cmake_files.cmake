...
set(GEL_SCRIPTING
	...
	"${SRC_DIR}/Gel/Scripting/vecpair.h.bak"
...
set(GFX_DX9
	"${SRC_DIR}/Gfx/DX8/p_NxGeom.cpp"
	"${SRC_DIR}/Gfx/DX8/p_NxGeom.h"
	"${SRC_DIR}/Gfx/DX8/p_NxImposter.cpp"
	"${SRC_DIR}/Gfx/DX8/p_NxImposter.h"
	"${SRC_DIR}/Gfx/DX8/p_NxLight.cpp"
	"${SRC_DIR}/Gfx/DX8/p_NxLight.h"
	"${SRC_DIR}/Gfx/DX8/p_NxLightMan.cpp"
	"${SRC_DIR}/Gfx/DX8/p_NxLoadScreen.cpp"
	"${SRC_DIR}/Gfx/DX8/p_NxMesh.cpp"
	"${SRC_DIR}/Gfx/DX8/p_NxMesh.h"
	"${SRC_DIR}/Gfx/DX8/p_NxModel.cpp"
	"${SRC_DIR}/Gfx/DX8/p_NxModel.h"
	"${SRC_DIR}/Gfx/DX8/p_NxParticleRibbonTrail.cpp"
	"${SRC_DIR}/Gfx/DX8/p_NxParticleRibbonTrail.h"
	"${SRC_DIR}/Gfx/DX8/p_NxParticleShaded.cpp"
	"${SRC_DIR}/Gfx/DX8/p_NxParticleShaded.h"
	"${SRC_DIR}/Gfx/DX8/p_NxParticleStar.cpp"
	"${SRC_DIR}/Gfx/DX8/p_NxParticleStar.h"
	"${SRC_DIR}/Gfx/DX8/p_NxSprite.cpp"
	"${SRC_DIR}/Gfx/DX8/p_NxSprite.h"
	"${SRC_DIR}/Gfx/DX8/p_NxTextured3dPoly.cpp"
	"${SRC_DIR}/Gfx/DX8/p_NxTextured3dPoly.h"
	"${SRC_DIR}/Gfx/DX8/p_NxViewMan.cpp"
	"${SRC_DIR}/Gfx/DX8/p_NxViewport.cpp"
	"${SRC_DIR}/Gfx/DX8/p_NxViewport.h"
	"${SRC_DIR}/Gfx/DX8/p_NxWin2D.cpp"
	"${SRC_DIR}/Gfx/DX8/p_NxWin2D.h"
	"${SRC_DIR}/Gfx/DX8/p_gfxman.cpp"
	"${SRC_DIR}/Gfx/DX8/p_loadscreen.cpp"
	"${SRC_DIR}/Gfx/DX8/p_memview.cpp"
	"${SRC_DIR}/Gfx/DX8/p_memview.h"
	"${SRC_DIR}/Gfx/DX8/p_nx.cpp"
	"${SRC_DIR}/Gfx/DX8/p_nxfont.cpp"
	"${SRC_DIR}/Gfx/DX8/p_nxfont.h"
	"${SRC_DIR}/Gfx/DX8/p_nxfontman.cpp"
	"${SRC_DIR}/Gfx/DX8/p_nxmiscfx.cpp"
	"${SRC_DIR}/Gfx/DX8/p_nxnewparticle.cpp"
	"${SRC_DIR}/Gfx/DX8/p_nxnewparticle.h"
	"${SRC_DIR}/Gfx/DX8/p_nxnewparticlemgr.cpp"
	"${SRC_DIR}/Gfx/DX8/p_nxnewparticlemgr.h"
	"${SRC_DIR}/Gfx/DX8/p_nxparticle.cpp"
	"${SRC_DIR}/Gfx/DX8/p_nxparticle.h"
	"${SRC_DIR}/Gfx/DX8/p_nxparticleflat.cpp"
	"${SRC_DIR}/Gfx/DX8/p_nxparticleflat.h"
	"${SRC_DIR}/Gfx/DX8/p_nxparticleglow.cpp"
	"${SRC_DIR}/Gfx/DX8/p_nxparticleglow.h"
	"${SRC_DIR}/Gfx/DX8/p_nxparticleglowribbontrail.cpp"
	"${SRC_DIR}/Gfx/DX8/p_nxparticleglowribbontrail.h"
	"${SRC_DIR}/Gfx/DX8/p_nxparticleline.cpp"
	"${SRC_DIR}/Gfx/DX8/p_nxparticleline.h"
	"${SRC_DIR}/Gfx/DX8/p_nxparticleribbon.cpp"
	"${SRC_DIR}/Gfx/DX8/p_nxparticleribbon.h"
	"${SRC_DIR}/Gfx/DX8/p_nxparticlesmooth.cpp"
	"${SRC_DIR}/Gfx/DX8/p_nxparticlesmooth.h"
	"${SRC_DIR}/Gfx/DX8/p_nxparticlesmoothribbon.cpp"
	"${SRC_DIR}/Gfx/DX8/p_nxparticlesmoothribbon.h"
	"${SRC_DIR}/Gfx/DX8/p_nxparticlesmoothstar.cpp"
	"${SRC_DIR}/Gfx/DX8/p_nxparticlesmoothstar.h"
	"${SRC_DIR}/Gfx/DX8/p_nxscene.cpp"
	"${SRC_DIR}/Gfx/DX8/p_nxscene.h"
	"${SRC_DIR}/Gfx/DX8/p_nxsector.cpp"
	"${SRC_DIR}/Gfx/DX8/p_nxsector.h"
	"${SRC_DIR}/Gfx/DX8/p_nxtexman.cpp"
	"${SRC_DIR}/Gfx/DX8/p_nxtexture.cpp"
	"${SRC_DIR}/Gfx/DX8/p_nxtexture.h"
	"${SRC_DIR}/Gfx/DX8/p_nxweather.cpp"
	"${SRC_DIR}/Gfx/DX8/p_nxweather.h"
)
source_group("Gfx/DX9" FILES ${GFX_DX9})

set(GFX_DX9_NX
	"${SRC_DIR}/Gfx/DX8/NX/BillboardScreenAlignedVS.h"
	"${SRC_DIR}/Gfx/DX8/NX/BillboardScreenAlignedVS.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/ParticleFlatVS.h"
	"${SRC_DIR}/Gfx/DX8/NX/ParticleFlatVS.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/ParticleNewFlatPointSpriteVS.h"
	"${SRC_DIR}/Gfx/DX8/NX/ParticleNewFlatPointSpriteVS.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/ParticleNewFlatVS.h"
	"${SRC_DIR}/Gfx/DX8/NX/ParticleNewFlatVS.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/PixelShader0.psh"
	"${SRC_DIR}/Gfx/DX8/NX/PixelShader0IVA.psh"
	"${SRC_DIR}/Gfx/DX8/NX/PixelShader1.psh"
	"${SRC_DIR}/Gfx/DX8/NX/PixelShader2.psh"
	"${SRC_DIR}/Gfx/DX8/NX/PixelShader3.psh"
	"${SRC_DIR}/Gfx/DX8/NX/PixelShader4.psh"
	"${SRC_DIR}/Gfx/DX8/NX/PixelShader5.psh"
	"${SRC_DIR}/Gfx/DX8/NX/PixelShaderBrighten.psh"
	"${SRC_DIR}/Gfx/DX8/NX/PixelShaderBrightenIVA.psh"
	"${SRC_DIR}/Gfx/DX8/NX/PixelShaderBumpWater.psh"
	"${SRC_DIR}/Gfx/DX8/NX/PixelShaderFocusBlur.psh"
	"${SRC_DIR}/Gfx/DX8/NX/PixelShaderFocusIntegrate.psh"
	"${SRC_DIR}/Gfx/DX8/NX/PixelShaderFocusLookupIntegrate.psh"
	"${SRC_DIR}/Gfx/DX8/NX/PixelShaderNULL.psh"
	"${SRC_DIR}/Gfx/DX8/NX/PixelShaderPointSprite.psh"
	"${SRC_DIR}/Gfx/DX8/NX/PixelShader_ShadowBuffer.psh"
	"${SRC_DIR}/Gfx/DX8/NX/ShadowBufferStaticGeomPS.psh"
	"${SRC_DIR}/Gfx/DX8/NX/ShadowBufferStaticGeomVS.h"
	"${SRC_DIR}/Gfx/DX8/NX/ShadowBufferStaticGeomVS.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_1Weight.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_2Weight.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_3Weight.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_1Weight.h"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_1Weight.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_1Weight_SBPassThru.h"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_1Weight_SBPassThru.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_1Weight_UVTransform.h"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_1Weight_UVTransform.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_2Weight.h"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_2Weight.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_2Weight_SBPassThru.h"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_2Weight_SBPassThru.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_2Weight_UVTransform.h"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_2Weight_UVTransform.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_3Weight.h"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_3Weight.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_3Weight_SBPassThru.h"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_3Weight_SBPassThru.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_3Weight_UVTransform.h"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_3Weight_UVTransform.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_4Weight.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_4Weight_SBPassThru.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_Specular_1Weight.h"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_Specular_1Weight.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_Specular_2Weight.h"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_Specular_2Weight.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_Specular_3Weight.h"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_Specular_3Weight.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVS_VXC_Specular_4Weight.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVertexShader0.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVertexShader1.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVertexShader_SBWrite.h"
	"${SRC_DIR}/Gfx/DX8/NX/WeightedMeshVertexShader_SBWrite.vsh"
	"${SRC_DIR}/Gfx/DX8/NX/anim.cpp"
	"${SRC_DIR}/Gfx/DX8/NX/anim.h"
	"${SRC_DIR}/Gfx/DX8/NX/anim_vertdefs.h"
	"${SRC_DIR}/Gfx/DX8/NX/billboard.cpp"
	"${SRC_DIR}/Gfx/DX8/NX/billboard.h"
	"${SRC_DIR}/Gfx/DX8/NX/chars.cpp"
	"${SRC_DIR}/Gfx/DX8/NX/chars.h"
	"${SRC_DIR}/Gfx/DX8/NX/gamma.cpp"
	"${SRC_DIR}/Gfx/DX8/NX/gamma.h"
	"${SRC_DIR}/Gfx/DX8/NX/grass.cpp"
	"${SRC_DIR}/Gfx/DX8/NX/grass.h"
	"${SRC_DIR}/Gfx/DX8/NX/instance.cpp"
	"${SRC_DIR}/Gfx/DX8/NX/instance.h"
	"${SRC_DIR}/Gfx/DX8/NX/material.cpp"
	"${SRC_DIR}/Gfx/DX8/NX/material.h"
	"${SRC_DIR}/Gfx/DX8/NX/mesh.cpp"
	"${SRC_DIR}/Gfx/DX8/NX/mesh.h"
	"${SRC_DIR}/Gfx/DX8/NX/mipmap.inl"
	"${SRC_DIR}/Gfx/DX8/NX/nx_init.cpp"
	"${SRC_DIR}/Gfx/DX8/NX/nx_init.cpp.bak"
	"${SRC_DIR}/Gfx/DX8/NX/nx_init.h"
	"${SRC_DIR}/Gfx/DX8/NX/occlude.cpp"
	"${SRC_DIR}/Gfx/DX8/NX/occlude.h"
	"${SRC_DIR}/Gfx/DX8/NX/particles.cpp"
	"${SRC_DIR}/Gfx/DX8/NX/particles.h"
	"${SRC_DIR}/Gfx/DX8/NX/render.cpp"
	"${SRC_DIR}/Gfx/DX8/NX/render.h"
	"${SRC_DIR}/Gfx/DX8/NX/scene.cpp"
	"${SRC_DIR}/Gfx/DX8/NX/scene.h"
	"${SRC_DIR}/Gfx/DX8/NX/screenfx.cpp"
	"${SRC_DIR}/Gfx/DX8/NX/screenfx.h"
	"${SRC_DIR}/Gfx/DX8/NX/sprite.cpp"
	"${SRC_DIR}/Gfx/DX8/NX/sprite.h"
	"${SRC_DIR}/Gfx/DX8/NX/swizzleformat.h"
	"${SRC_DIR}/Gfx/DX8/NX/texture.cpp"
	"${SRC_DIR}/Gfx/DX8/NX/texture.h"
	"${SRC_DIR}/Gfx/DX8/NX/verlet.cpp"
	"${SRC_DIR}/Gfx/DX8/NX/verlet.h"
	"${SRC_DIR}/Gfx/DX8/NX/xbmemfnt.h"
)
